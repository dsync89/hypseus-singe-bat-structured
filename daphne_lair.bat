...
:: Launch Game
hypseus.exe %GAME_NAME% vldp -framefile vldp\%GAME_NAME%\%GAME_NAME%.txt -fullscreen -bank 1 00110111 -bank 0 10011000 -fastboot -volume_nonvldp 20 -volume_vldp 80 -nolinear_scale