...
:: Launch Game
hypseus.exe %GAME_NAME% vldp -framefile vldp\%GAME_NAME%\%GAME_NAME%.txt -fullscreen -fastboot -vertical_stretch 24 -volume_nonvldp 20 -volume_vldp 80 -nolinear_scale