...
:: Launch Game
hypseus.exe %GAME_NAME% vldp -framefile vldp\%GAME_NAME%\%GAME_NAME%.txt -fullscreen -bank 0 00000000 -bank 1 00000000 -fastboot -volume_nonvldp 20 -volume_vldp 80 -nolinear_scale